...
class UserRepo:
    ...
    def create_user(self, full_name: str, position: str, secret_key: str, create_time: datetime.datetime, kill_time: datetime.datetime = None) -> Users:
        ...
        :param secret_key: Unique secret key that generated by the administrator when creating the pass
        :param: kill_time: Data time of automatic deleting User from Data Base
